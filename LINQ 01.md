...
var methodSyntax = context.Employees.Select(e => e.FirstName).ToList();

var querySyntax = (from e in context.Employees select e.FirstName).ToList();
```
...
var methodSyntax = context.Employees.Select(e => string.Concat(e.FirstName , ' ' , e.LastName)).ToList();

var querySyntax = (from e in context.Employees select string.Concat(e.FirstName , ' ' , e.LastName)).ToList();
```
...
var methodSyntax = context.Employees.Select(e => new { e.DepartmentId , e.JobId }).Distinct().ToList();

var querySyntax = (from e in context.Employees select new { e.DepartmentId , e.JobId }).Distinct().ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.DepartmentId != null).Select(e => e.DepartmentId).Distinct().Count();

var querySyntax = (from e in context.Employees where e.DepartmentId != null select e.DepartmentId).Distinct().Count();
```
...
var methodSyntax = context.Employees.Where(e => e.DepartmentId == 90).Select(e => e.FirstName).ToList();

var querySyntax = (from e in context.Employees where e.DepartmentId == 90 select e.FirstName).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.Salary != 10000).Select(e => new { e.FirstName , e.Salary }).ToList();

var querySyntax = (from e in context.Employees where e.Salary != 10000 select new { e.FirstName , e.Salary }).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.HireDate > new DateTime(2000 , 3 , 8)).Select(e => e.FirstName).ToList();

var querySyntax = (from e in context.Employees where e.HireDate > new DateTime(2000 , 3 , 8) select e.FirstName).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.Salary < 5000).Select(e => new { e.FirstName , e.Salary }).ToList();

var querySyntax = (from e in context.Employees where e.Salary < 5000 select new { e.FirstName , e.Salary }).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.Salary >= 2500 && e.Salary <= 3500).Select(e => new { e.FirstName , e.Salary }).ToList();

var querySyntax = (from e in context.Employees where e.Salary >= 2500 && e.Salary <= 3500 select new { e.FirstName , e.Salary }).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.JobId == "AD_PRES" || e.JobId == "IT_PROG" || e.JobId == "FI_ACCOUNT").Select(e => new { e.FirstName , e.JobId }).ToList();

var querySyntax = (from e in context.Employees where e.JobId == "AD_PRES" || e.JobId == "IT_PROG" || e.JobId == "FI_ACCOUNT" select new { e.FirstName , e.JobId }).ToList();
```

## Question 13
Write a LINQ expression to retrieve the first names and job IDs of all employees who don't hold the job titles `AD_PRES` or `IT_PROG`.
```csharp
var context = new EmployeeContext();

var methodSyntax = context.Employees.Where(e => !(e.JobId == "AD_PRES" || e.JobId == "IT_PROG")).Select(e => new { e.FirstName , e.JobId }).ToList();

var querySyntax = (from e in context.Employees where !(e.JobId == "AD_PRES" || e.JobId == "IT_PROG") select new { e.FirstName , e.JobId }).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.DepartmentId == 90 || e.Salary > 6000).Select(e => new { e.FirstName , e.DepartmentId , e.Salary }).ToList();

var querySyntax = (from e in context.Employees where e.DepartmentId == 90 || e.Salary > 6000 select new { e.FirstName , e.DepartmentId , e.Salary }).ToList();
```
...
var methodSyntax = context.Employees.Where(e => e.DepartmentId == null).Select(e => e.FirstName).ToList();

var querySyntax = (from e in context.Employees where e.DepartmentId == null select e.FirstName).ToList();
```
